...
function aCatGetChildren(){
	global $wpdb, $post;
	$parent = intval($_POST['parent']); // ID, should be INT
	$catSlug = sanitize_key($_POST['catSlug']); // category slug, should be sanitized string
	$orderby = sanitize_key($_POST['orderby']);
	$order = htmlspecialchars($_POST['order']);
	$argName = sanitize_key($_POST['argName']);
